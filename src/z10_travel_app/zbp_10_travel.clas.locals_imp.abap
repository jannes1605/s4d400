...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD ValidateCustomer.
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_10_TravelTP.

    " Read Travels
    READ ENTITIES OF ZR_10_TravelTP IN LOCAL MODE
         ENTITY Travel
         FIELDS ( CustomerId )
  ...
  METHOD DetermineStatus.
    DATA travels TYPE TABLE FOR UPDATE zr_10_traveltp.
    ...
    MODIFY ENTITIES OF zr_10_traveltp IN LOCAL MODE
           ENTITY Travel
           UPDATE
           FIELDS ( Status )
           WITH travels.
